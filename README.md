...
| Projekt | Status | Opis |
|---|---|---|
| [01-stm32-mini-devboard](projects/01-stm32-mini-devboard/) | 🟡 w toku — dobór komponentów zakończony, schemat do zrobienia | Minimalna płytka dev ze STM32F411, USB-C, SWD; też carrier testowy dla modułów 02-05 |
